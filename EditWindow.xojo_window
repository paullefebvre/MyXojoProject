...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub SetValues(pk As Integer, name As String, coach As String, city As String)
		  mPK = pk
		  NameField.Text = name
